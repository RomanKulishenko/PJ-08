export default class Slide {
  ...
  renderTemplate(): string {
    return `
			<div class="slider__slide${this.id === 0 ? " active" : ""}" data-index="${
      this.id
    }">
				<!--<div class="slider__slide-info">
					...
					<a class="slider__slide-button" href="${
            this.link
          }" target="_blank">Текст кнопки</a>
				</div>-->
				<div class="slider__slide-image"><img src="${
          this.imageURL
        }" alt="img" width="940" height="860"></div>
			</div>
		`;
  }
}
