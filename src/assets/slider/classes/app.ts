...
export default class App {
  ...
  public init(): void {
    ...
    async function insertNavigation(
      ...
      const sliderHTMLContainer: HTMLElement = container.querySelector(
        ".slider"
      ) as HTMLElement;
      const slidesHTML: NodeListOf<Element> =
        sliderHTMLContainer.querySelectorAll(".slider__slide");
      sliderHTMLContainer.insertAdjacentHTML(
        "afterbegin",
        await navigation.renderTemplate(slidesHTML.length)
      );
